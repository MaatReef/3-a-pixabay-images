...
function buscarImagenes() {
    ...
    const key = '24280144-a2f59973412b38735eb1e4382';
            ...
            <div class="w-1/2 md:w-1/3 lg:w-1/4 mb-4 p-3">
                <div class="bg-white rounded">
                    ...
                    <div class="p-4">
                        ...
                        target="_blank" class="bg-red-800 w-full p-1 block mt-5 rounded text-center font-bold uppercase hover:bg-red-600 text-white">Ver Imagen</a>
                    </div>
                </div>
            </div>
            `;
...
function mostrarPaginacion() {
    ...
    while( true ) {
        ...
        botonSiguiente.classList.add('siguiente', 'bg-red-400', 'px-4', 'py-1', 'mr-2', 'font-bold', 'mb-4', 'rounded', 'hover:bg-red-600');
